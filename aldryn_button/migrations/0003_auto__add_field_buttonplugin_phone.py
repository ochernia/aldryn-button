...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ButtonPlugin.phone'
        db.add_column(u'aldryn_button_buttonplugin', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ButtonPlugin.phone'
        db.delete_column(u'aldryn_button_buttonplugin', 'phone')
