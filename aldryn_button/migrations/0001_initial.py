    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', filer.fields.file.FilerFileField(blank=True, to='filer.File', help_text='A file has priority over a phone number.', null=True, verbose_name='File', on_delete=models.CASCADE)),
