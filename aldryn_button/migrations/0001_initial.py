...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'aldryn_button_buttonplugin', (
            ...
            ('css_classes', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('css_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'aldryn_button', ['ButtonPlugin'])


    def backwards(self, orm):
        # Deleting model 'ButtonPlugin'
        db.delete_table(u'aldryn_button_buttonplugin')


    models = {
        u'aldryn_button.buttonplugin': {
            'Meta': {'object_name': 'ButtonPlugin', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'css_classes': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
