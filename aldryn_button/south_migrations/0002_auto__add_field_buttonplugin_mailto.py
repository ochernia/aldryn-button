...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ButtonPlugin.mailto'
        db.add_column(u'aldryn_button_buttonplugin', 'mailto',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ButtonPlugin.mailto'
        db.delete_column(u'aldryn_button_buttonplugin', 'mailto')
