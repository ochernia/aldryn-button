...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ButtonPlugin.file'
        db.add_column(u'aldryn_button_buttonplugin', 'file',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ButtonPlugin.file'
        db.delete_column(u'aldryn_button_buttonplugin', 'file_id')
