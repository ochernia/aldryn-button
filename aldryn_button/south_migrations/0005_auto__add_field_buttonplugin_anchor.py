...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ButtonPlugin.anchor'
        db.add_column(u'aldryn_button_buttonplugin', 'anchor',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ButtonPlugin.anchor'
        db.delete_column(u'aldryn_button_buttonplugin', 'anchor')


    models = {
        u'aldryn_button.buttonplugin': {
            'Meta': {'object_name': 'ButtonPlugin', '_ormbases': ['cms.CMSPlugin']},
            'anchor': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
